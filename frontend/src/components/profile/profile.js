...
const Profile = () => {
  ...
  const fetchUserProfile = async () => {
    try {
      ...
      updateProfile({
        ...
        easy: userProfile.data.matchedUser.submitStats.totalSubmissionNum[1]
          .count,
        medium:
          userProfile.data.matchedUser.submitStats.totalSubmissionNum[2].count,
        hard: userProfile.data.matchedUser.submitStats.totalSubmissionNum[3]
          .count,
  ...
  useEffect(() => {
    ...
    fetchUserProfile();
    console.log(
      profile + "submission calendar is " + profile.submissionCalendar
    );
  }, []);
  return (
      ...
      <div className="navbar">
        ...
        <div className="profile-container">
          <div className="container-left">
            ...
            <div className="info">
              <div className="name">{leetcodeName}</div>
              <div className="description">
                I am a sophomore studing at Indian Institute of Information
                Technology, Vadodara
              </div>
              ...
              <div className="profile-container">
                <div className="container-left">
                  ...
                  <div className="info">
                    <div className="name">{leetcodeName}</div>
                    <div className="description">
                      I am a sophomore studing at Indian Institute of
